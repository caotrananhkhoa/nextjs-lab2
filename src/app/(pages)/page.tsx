...
const Home = () => {
  ...
  return (
    <div className="w-full h-full max-w-7xl mx-auto px-8">
      <div className="flex flex-wrap -mx-2 mt-8 gap-y-8">
        <div className="w-full md:w-1/2 px-2 flex justify-center flex-wrap items-center">
          <div className="relative text-center w-full flex justify-center flex-wrap">
            <div className="w-full max-w-[80px]">
              <img src="./favicon.ico" alt="Logo" />
            </div>
            <div className="w-full">
              <h1 className="font-bold text-3xl mb-4 mt-4">
        ...
        <div className="w-full md:w-1/2 px-2 flex flex-wrap justify-center items-center">
          {authStatus ? (
